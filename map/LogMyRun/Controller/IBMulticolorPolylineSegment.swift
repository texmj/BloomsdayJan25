//
//  IBMulticolorPolylineSegment.swift
//  LogMyRun
//
...
class IBMulticolorPolylineSegment: MKPolyline {
    ...
    class func colorSegments(forLocations locations:[Location]) -> [IBMulticolorPolylineSegment] {
        var colorSegments = [IBMulticolorPolylineSegment]()
        ...
        for i in 1..<locations.count {
            ...
            let segment = IBMulticolorPolylineSegment(coordinates: &coords, count: coords.count)
            segment.color = color
